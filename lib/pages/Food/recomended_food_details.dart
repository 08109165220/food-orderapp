...
import 'package:foodorder_m/widgets/expandable_text_widget.dart';
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      BigText(text: "\$${product.price!}  x  ${controller.inCartItems} ",color: AppColors.mainBlackColor,size: Dimensions.fomt26),
                      GestureDetector(
                        onTap: () {
